...
<body><br><h1><font color="green">HABITATION</font><font color="gold"> OF </font> <font color="black">HOPE</font><font color="white"> AND </font><font color="red"> TRANSFORMATION</font> <font color="white">CENTRE</font></h1><h2><font color="silver">Inmate Data</font></h2>
<?php
	$server = "localhost";
	$username = "root";
	$password = "";
